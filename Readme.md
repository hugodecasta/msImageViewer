# msImageViewer
## Hugo Castaneda - 02/10/2017

### Le dossier contient:
* Le code source du programme (code édité sous Processing d'où les .pde)
* Un fichier .java correspondant au wrap des pde pour une compilation java simple (en important les librairies Processing)
	
### Utilisation:
* En ouvrant le programme, il vous sera demandé de selectionner un dossier de travail
* Selectionner un dossier "éléments" contenant les dossiers images analysées et découpées
* Pour visualiser les blob, cliquer sur l'image à visionner puis suivre les instructions à l'écran
